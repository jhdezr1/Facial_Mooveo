...
Python file intended to obtain the euclidian distance of keypoints of the chin to measure the tremor and the amplitude
...
for frame, points in data.items():
    ref_points = points['Ref']
    chin_points = points['Chin']
    frame_distances = []

    for p0, p1 in zip(ref_points, chin_points):
