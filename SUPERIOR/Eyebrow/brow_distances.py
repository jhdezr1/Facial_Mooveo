...
Python file intended to obtain the euclidian distance of keypoints of both brows to measure the amplitude and movement
of the forehead during a video.
...
for frame, points in data.items():
    upper0_points = points['brow']
    upper1_points = points['ref']
    frame_distances = []
